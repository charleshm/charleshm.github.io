...
首先我们需要根据数据建立Graph，Graph的每一个节点对应一个数据点，边的权重用于表示数据之间的相似度（高斯距离），我们通常采用的是mutual K-nearest-neighbor graph（你是我的n近邻，你也必须是我的n近邻才算）。
...
[6]:http://7xjbdi.com1.z0.glb.clouddn.com/mknngraph.png?imageView2/2/w/500
