...
我们要化简的是式\[em1\]，这个时候可以将 $ \mathcal{P}(\textbf{z}|\textbf{X},\theta^n) $ 看做式\[em2\]中的 $ \lambda_i $ ，  

$\frac{\mathcal{P}(\textbf{X}|\textbf{z},\theta)\mathcal{P}(\textbf{z}|\theta)}{\mathcal{P}(\textbf{z}|\textbf{X},\theta^n)} $ 看做式\[em2\]中的 $ x_i $ ，则有：
