...
期望最大化(ExpectationMaximization)算法最初是由 Ceppellini\[2\]等人1950年在讨论基因频率的估计的时候提出的。后来又被Hartley\[3\]和Baum\[4\]等人发展的更加广泛。目前引用的较多的是1977年Dempster\[5\]等人的工作。它主要用于从的数据中计算最大似然估计。后来经过其他学者的发展，这个算法也被用于聚类等应用。
...
![image](/assets/EM/bexp.png){width="80.00000%"}
